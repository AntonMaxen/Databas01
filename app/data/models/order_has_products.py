...
class OrderProduct(Base):
    __tablename__ = 'order_has_products'
    ...
    products = relationship('Product', back_populates='order_has_products')
    orders = relationship('Order', back_populates='order_has_products')
